...
One package "swarm_robot_description" will describe the robot models, one simple model could be a two-wheel cubic robot, and also the gazebo environment setting files and launch files.

One package "swarm_robot_msgs" will contain the costomized messages and services that will be used in other packages.

One package "swarm_robot_simulator" will contain simulators for physical properties, including actuation, communication and sensing capabilities.

One package "swarm_robot_controller" will be the place in which different control algorithms reside.
